...
//        设置每个Card的背景色
    ...
    private List createList(int size) {
        ...
        for (int i = 1; i <= size; i++) {
            BuildingCard ci = new BuildingCard();
            ci.buildingImage = getResources().getDrawable(R.drawable.building_example);
            ci.buildingName = BuildingCard.NAME_PREFIX + i;
            ci.buildingOpeningTime = BuildingCard.TIME_PREFIX + i;
