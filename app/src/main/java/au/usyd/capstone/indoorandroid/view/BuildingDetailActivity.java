...
public class BuildingDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbarBuildingDetail);
...
//        将title设置在CollapsiingToolbarLayout上
        CollapsingToolbarLayout mCollapsingToolbarLayout = (CollapsingToolbarLayout) findViewById(R.id.collapsingToolbarBuildingDetail);
        mCollapsingToolbarLayout.setTitle(title);

//        设置CollapsingToolbar上的图片
        ImageView imageView = (ImageView) findViewById(R.id.imageViewBuildingDetail);
        ...
        // init RecyclerView
        mRecyclerView = (RecyclerView) findViewById(R.id.recyclerViewBuildingDetail);
        Log.e("BuildingDetailActivity", "mRecyclerView create");

        // use a linear layout manager
        mLayoutManager = new LinearLayoutManager(this);
        mRecyclerView.setLayoutManager(mLayoutManager);
        Log.e("BuildingDetailActivity", "mLayoutManager");

        // specify an adapter (see also next example)
        mAdapter = new BuildingAdapter(this, createList(20));
        mRecyclerView.setAdapter(mAdapter);
        Log.e("BuildingDetailActivity", "mAdapter");
